...
> 拆分日期: 2026-06-03
> 注意: 部分步骤因 git2dart 方案废弃需要重写，详见 `../doc_review_analysis.md`
...
| [1.2_integrate_deps.md](01_project_init/1.2_integrate_deps.md) | 集成核心依赖库 | ⚠️ 需重写(移除git2dart) |
...
| [2.1.2_database.md](02_core_features/feature_01_add_tracking/2.1.2_database.md) | 本地数据库 | ✅ |
| [2.1.3_init_repo.md](02_core_features/feature_01_add_tracking/2.1.3_init_repo.md) | 文件标记和仓库初始化 | ⚠️ 需重写(去除git) |
...
| 文件 | 步骤 | 状态 |
|------|------|------|
| [2.3.1_delete.md](02_core_features/feature_03_delete_tracking/2.3.1_delete.md) | 删除版本追踪 | ✅ |
...
| [2.6.4_auto_commit.md](02_core_features/feature_06_auto_save/2.6.4_auto_commit.md) | 自动提交 | ⚠️ 需重写(去除git) |
...
| [2.7.1_timeline_data.md](02_core_features/feature_07_show_changes/2.7.1_timeline_data.md) | 时间轴数据读取 | ⚠️ 需重写(去除git) |
| [2.7.2_timeline_ui.md](02_core_features/feature_07_show_changes/2.7.2_timeline_ui.md) | 时间轴UI展示 | ✅ |
| [2.7.3_diff_algorithm.md](02_core_features/feature_07_show_changes/2.7.3_diff_algorithm.md) | diff算法集成 | ⚠️ 需重写(Myers替换LCS) |
...
| [2.7.6_version_rollback.md](02_core_features/feature_07_show_changes/2.7.6_version_rollback.md) | 版本回退 | ⚠️ 需重写(去除git) |
...
| 文件 | 步骤 | 状态 |
|------|------|------|
| [2.12.1_export.md](02_core_features/feature_12_backup/2.12.1_export.md) | 数据导出 | ⚠️ 需重写(去除git) |
| [2.12.2_import.md](02_core_features/feature_12_backup/2.12.2_import.md) | 数据导入 | ⚠️ 需重写(去除git) |
...
| [3.3_cross_platform_test.md](03_integration_test/3.3_cross_platform_test.md) | 跨平台测试 | ⚠️ 需重写(去除git2dart) |
...
**状态说明**:
- ✅ 内容正确，可直接使用
- ⚠️ 需重写：因 git2dart 方案废弃或其他原因需要更新
- P2: 远期目标，当前版本不需要实现